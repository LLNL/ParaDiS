/**************************************************************************
 *
 *      Module:       Mobility_FCC_linear_Eshelby.c
 ...
 *                    MobilityLaw_FCC_linear_Eshelby()
 *
...
/**************************************************************************
 *
 *      Function:     MobilityLaw_FCC_linear_Eshelby
...
int Mobility_FCC_linear_Eshelby(Home_t *home, Node_t *node, MobArgs_t *mobArgs)
{
        ...
        real8 mu, maxSegLen, maxVal = 0.0;
        real8 massMult=0, massMatrix[3][3], eps;
        real8 vTest[3], vOld[3], fn[3], rt[3], t[3], plane[3];
 ...
 */
        if (numNbrs > MAX_NBRS) {
            Fatal("Mobility_FCC_linear_Eshelby: Node segment count (%d) exceeds\n"
 ...
 */
        ...
        if ((isnan(node->vX) || isinf(node->vX)) ||
            ...
            PrintNode(node);
            Fatal("Mobility_FCC_linear_Eshelby: (%d, %d) velocity error.",
